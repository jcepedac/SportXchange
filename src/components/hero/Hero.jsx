...
const tags = ["Football", "Basketball", "Volleyball", "Badminton", "Soccer", "Tennis"];
            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                <p className="text-4xl font-bold text-neutral lg:text-4xl">
                  ...
                  <span className="text-pink-500 opacity-100 transition-opacity duration-2000">
                    {tagName}
                  </span>
                  {" "}equipment
                </p>
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Get value for your used sports gear and find great deals.
                </p>

                <Link to="/all">
                  <button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-pink-600 rounded-lg lg:w-auto hover:bg-pink-500 focus:outline-none focus:bg-blue-500">
                    Shop Now
                  </button>
                </Link>
              </div>
