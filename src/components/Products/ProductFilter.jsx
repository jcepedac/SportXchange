...
const ProductFilter = () => {
	...
	return (
		<div className="flex flex-col gap-y-5">
			...
			<div>
				<button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-pink-600 rounded-lg lg:w-auto hover:bg-pink-500 focus:outline-none focus:bg-blue-500" onClick={clearFilter}>
					Clear Filters
				</button>
			</div>
		</div>
